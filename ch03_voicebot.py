...
def main():
    ...
    if "messages" not in st.session_state:
        st.session_state["messages"]=[{
            "role":"system",
            "content":"You are a thoughtful assistant. Respond to all input in 25 words in Korean"
        }]
    ...
    with st.sidebar:
        ...
        st.session_state["OPENAI_API"] = st.text_input(
            label="OPEN API 키", placeholder="Enter your API KEY", 
            value="", type="password"
            )
